...
import { Card, Row, Col, CardHeader, CardBody, FormGroup, Form, Input, CardFooter, Button } from "reactstrap";


const PostalReceived = () => {
        ...
        <div className="content">
            <Row>
                <Col md="4">
                    <Card>
                        <CardHeader>
                            <h5 className="title">Postal Dispatch Form</h5>
                        </CardHeader>
                        <CardBody>
                            <Form>
                                <Row>
